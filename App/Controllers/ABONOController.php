...
class ABONOController{
    ...
    static function main($action)
    {
        if ($action == "create") {
            ...
            ABONOController::searchForID($_REQUEST['idPersona']);
    ...
    static public function create()
    {
        try {
            $arrayABONO = array();
            $arrayABONO['Codigo'] = $_POST['Codigo'];
            $arrayABONO['Fecha'] = $_POST['Fecha'];
            $arrayABONO['Descripcion'] = $_POST['Descripcion'];
            $arrayABONO['MetodoPago'] = $_POST['MetodoPago'];
    ...
    static public function edit (){
        try {
            ...
            $user = new ABONO($arrayABONO);
            $user->update();

            header("Location: ../../views/modules/ABONO/show.php?id=".$user->getId()."&respuesta=correcto");
        } catch (\Exception $e) {
            //var_dump($e);
    ...
    static public function activate (){
        try {
            $ObjABONO = ABONO::searchForId($_GET['Codigo']);
            $ObjABONO->setEstado("Activo");
            if($ObjABONO->update()){
    ...
    static public function inactivate (){
        try {
            ...
            //var_dump($e);
            header("Location: ../../views/modules/ABONO/index.php?respuesta=error");
        }
    }

    static public function searchForID ($Codigo){
        try {
            return ABONO::searchForId($Codigo);
        } catch (\Exception $e) {
            var_dump($e);
