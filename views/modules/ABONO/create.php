                ...
                <?php if ($_GET['respuesta'] != "correcto"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <h5><i class="icon fas fa-ban"></i> Error!</h5>
                            Error al crear el abono: <?= $_GET['mensaje'] ?>
                    </div>
                <?php } ?>
            <?php } ?>
                ...
                <form class="form-horizontal" method="post" id="frmCreateAbono" name="frmCreateAbono" action="../../../app/Controllers/ABONOController.php?action=create">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input required type="text" minlength="6" class="form-control" id="MetodoPago" name="MetodoPago" placeholder="Ingrese el metodo de pago">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Valor" class="col-sm-2 col-form-label">Valor</label>
                            <div class="col-sm-10">
                                <input required type="number" minlength="6" class="form-control" id="Valor" name="Valor" placeholder="Ingrese el valor">
                            </div>
                        </div>
