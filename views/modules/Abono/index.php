        ...
        <section class="content">
                ...
                <?php if ($_GET['respuesta'] == "correcto"){ ?>
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <?php if ($_GET['action'] == "create"){ ?>
                            Abono  ha sido creada con exito!
                        <?php }else if($_GET['action'] == "update"){ ?>
                            Los datos de Abono han sido actualizados correctamente!
                        <?php } ?>
                    </div>
                <?php } ?>
            <?php } ?>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Gestionar Abono </h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <table id="tblAbono" class="datatable table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Venta</th>
                                ...
                                <tbody>
                                <?php
                                $arrProducto = AbonoController::getAll();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($Producto->getEstado() != "activo"){ ?>
                                                <a href="../../../App/Controllers/AbonoController.php?action=activate&Id=<?php echo $Producto->getCodigo(); ?>" type="button" data-toggle="tooltip" title="Activar" class="btn docs-tooltip btn-success btn-xs"><i class="fa fa-check-square"></i></a>
                                            <?php }else{ ?>
                                                <a type="button" href="../../../App/Controllers/AbonoController.php?action=inactivate&Id=<?php echo $Producto->getCodigo(); ?>" data-toggle="tooltip" title="Inactivar" class="btn docs-tooltip btn-danger btn-xs"><i class="fa fa-times-circle"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
