...
<html lang="es">
<head>
    <title><?= getenv('TITLE_SITE') ?> |  Datos de Abono</title>
            ...
            <?php if(!empty($_GET['respuesta'])){ ?>
                <?php if ($_GET['respuesta'] == "error"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al consultar la  Abono: <?= ($_GET['mensaje']) ?? "" ?>
                    </div>
                <?php } ?>
                ...
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){
                    ...
                    if(!empty($DataProducto)){
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <hr>
                            <strong><i class="fas fa-book mr-1"></i> Valor</strong>
                            <p class="text-muted">
                                <?= $DataProducto->getValor() ?>
                            </p>
                            <hr>
                            <hr>
