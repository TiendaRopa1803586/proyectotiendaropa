            ...
            <?php if(!empty($_GET['respuesta'])){ ?>
                <?php if ($_GET['respuesta'] == "error"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al editar la Compra: <?= ($_GET['mensaje']) ?? "" ?>
                    </div>
                <?php } ?>
            ...
            <div class="card card-warning">
                ...
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){ ?>
                    ...
                    if(!empty($DataProducto)){
                        ?>
                        <!-- form start -->
                        <form class="form-horizontal" method="post" id="frmModificarCompra" name="frmModificarCompra" action="../../../App/Controllers/CompraController.php?action=edit">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <?= UsuariosController::selectUsuario(false,
                                            ...
                                            'Proveedor',
                                            'Proveedor',
                                            (!empty($DataProducto)) ? $DataProducto->getProveedor()->getDocumento() : '',
                                            'form-control select2bs4 select2-info',
                                            "")
                                        ?>
                                    </div>
