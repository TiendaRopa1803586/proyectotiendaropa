                ...
                <?php if ($_GET['respuesta'] == "correcto"){ ?>
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <?php if ($_GET['action'] == "create"){ ?>
                            Compra  ha sido creada con exito!
                        <?php }else if($_GET['action'] == "update"){ ?>
                            Los datos de Compra han sido actualizados correctamente!
                        <?php } ?>
                    </div>
                <?php } ?>
            <?php } ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <table id="tblVenta" class="datatable table table-bordered table-striped">
                                ...
                                <tbody>
                                <?php
                                $arrProducto = CompraController::getAll();
                                foreach ($arrProducto as $Producto){
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $Producto->getProveedor()->getNombre(); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($Producto->getEstado() != "activo"){ ?>
                                                <a href="../../../App/Controllers/CompraController.php?action=activate&Id=<?php echo $Producto->getCodigo(); ?>" type="button" data-toggle="tooltip" title="Activar" class="btn docs-tooltip btn-success btn-xs"><i class="fa fa-check-square"></i></a>
                                            <?php }else{ ?>
                                                <a type="button" href="../../../App/Controllers/CompraController.php?action=inactivate&Id=<?php echo $Producto->getCodigo(); ?>" data-toggle="tooltip" title="Inactivar" class="btn docs-tooltip btn-danger btn-xs"><i class="fa fa-times-circle"></i></a>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php } ?>
