...
<html lang="es">
<head>
    <title><?= getenv('TITLE_SITE') ?> |  Datos de Compra</title>
        ...
        <section class="content">
            ...
            <div class="card card-info">
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){
                    $DataProducto = CompraController::searchForID($_GET["id"]);
                    if(!empty($DataProducto)){
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted"><?= $DataProducto->getProveedor()->getNombre() ?></p>
                            <hr>
                            <hr>
