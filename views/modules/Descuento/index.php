        ...
        <section class="content">
                ...
                <?php if ($_GET['respuesta'] == "correcto"){ ?>
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <?php if ($_GET['action'] == "create"){ ?>
                           El descuento ha sido creada con exito!
                        <?php }else if($_GET['action'] == "update"){ ?>
                            Los datos del descuento han sido actualizados correctamente!
                        <?php } ?>
                    </div>
                <?php } ?>
            <?php } ?>
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Gestionar Descuento</h3>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <table id="tblDescuento" class="datatable table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>Nombre</th>
                                ...
                                <tbody>
                                <?php
                                $arrDescuento = DescuentoController::getAll();
