...
<html lang="es">
<head>
    <title><?= getenv('TITLE_SITE') ?> |  Datos del descuento</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Informacion del descuento</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
                ...
                <?php if ($_GET['respuesta'] == "error"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        <h5><i class="icon fas fa-ban"></i> Error!</h5>
                            Error al consultar el descuento: <?= ($_GET['mensaje']) ?? "" ?>
                    </div>
                <?php } ?>
            ...
            <div class="card card-info">
                ...
                <div class="card-header">
                    <h3 class="card-title"><?= $DataDescuento->getNombre()  ?></h3>
                </div>
                <div class="card-body">
                    <p>
                        ...
                        <p class="text-muted">
                            <?= $DataDescuento->getNombre() ?>
                        </p>
                        <hr>
                        <strong><i class="fas fa-user mr-1"></i> Porcentaje</strong>
                        <p class="text-muted"><?= $DataDescuento->getPorcentaje() ?></p>
                        <hr>
                        <hr>
                    ...
                    <div class="row">
                        <div class="col-auto mr-auto">
                            <a role="button" href="create.php" class="btn btn-success float-right" style="margin-right: 5px;">
                                <i class="fas fa-tasks"></i> Registrar Descuento
                            </a>
                        </div>
                        <div class="col-auto">
                            <a role="button" href="edit.php?id=<?php echo $DataDescuento->getCodigo(); ?>" class="btn btn-primary float-right" style="margin-right: 5px;">
                                <i class="fas fa-plus"></i> Editar Descuento
                            </a>
                        </div>
                    </div>
                </div>
