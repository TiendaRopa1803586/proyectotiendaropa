...
<html lang="es">
<head>
    <title><?= getenv('TITLE_SITE') ?> | Crear Inventario</title>
        ...
        <section class="content">
            ...
            <?php if(!empty($_GET['respuesta'])){ ?>
                <?php if ($_GET['respuesta'] != "correcto"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al crear Inventario: <?= $_GET['mensaje'] ?>
                    </div>
                <?php } ?>
            <?php } ?>
            ...
            <div class="card card-info">
                <div class="card-header">
                    <h3 class="card-title"> Formulario Inventario</h3>
                </div>
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" method="post" id="frmCreateInventario" name="frmCreateInventario" action="../../../App/Controllers/InventarioController.php?action=create">
                    <div class="card-body">
