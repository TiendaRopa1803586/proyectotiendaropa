                ...
                <form class="form-horizontal" method="post" id="frmCreateUsuario" name="frmCreateUsuario" action="../../../app/Controllers/UsuariosController.php?action=create">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input required type="text" class="form-control" id="Producto" name="Producto" placeholder="Ingrese Producto">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Compra" class="col-sm-2 col-form-label">Compra</label>
                            <div class="col-sm-10">
                                <input required type="email" minlength="6" class="form-control" id="Compra" name="Compra" placeholder="Ingrese su Compra">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input required type="text" minlength="6" class="form-control" id="IVA" name="IVA" placeholder="Ingrese IVA">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="Talla" class="col-sm-2 col-form-label">Talla</label>
                            <div class="col-sm-10">
                                <input required type="text" minlength="6" class="form-control" id="Talla" name="Talla" placeholder="Ingrese Talla">
                            </div>
                        </div>
                    </div>
                    <!-- /.card-body -->
