        ...
        <section class="content">
            ...
            <div class="card card-info">
                ...
                <div class="card-header">
                    <h3 class="card-title"><?= $DataUsuario->getNombre()  ?></h3>
                </div>
                <div class="card-body">
                    <p>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-auto mr-auto">
                            <a role="button" href="edit.php?documento=<?php echo $DataUsuario->getDocumento(); ?>" class="btn btn-success float-right" style="margin-right: 5px;">
                                <i class="fas fa-tasks"></i> modificar Usuario
                            </a>
                        </div>
                        <div class="col-auto">
