...
require_once("../../../App/Controllers/ItemVentaController.php");
            ...
            <?php if(!empty($_GET['respuesta'])){ ?>
                <?php if ($_GET['respuesta'] == "error"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al editar ItemVenta: <?= ($_GET['mensaje']) ?? "" ?>
                    </div>
                <?php } ?>
            ...
            <div class="card card-warning">
                ...
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){ ?>
                    ...
                    if(!empty($DataProducto)){
                        ?>
                        <!-- form start -->
                        <form class="form-horizontal" method="post" id="frmModificarItemVenta" name="frmModificarItemVenta" action="../../../App/Controllers/ItemVentaController.php?action=edit">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <label for="IVA" class="col-sm-2 col-form-label">Cantidad</label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input required type="text" class="form-control" id="PrecioTotal" name="PrecioTotal" value="<?= $DataProducto->getPrecioTotal(); ?>" placeholder="Ingrese PrecioTotal">
                                    </div>
                                </div>
                                <div class="form-group row">
