                        ...
                        <form class="form-horizontal" method="post" id="frmModificarMarca" name="frmModificarMarca" action="../../../app/Controllers/MarcaController.php?action=edit">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input required type="text" class="form-control" id="Nombre" name="Nombre" value="<?= $DataMarca->getNombre(); ?>" placeholder="Ingrese nombre de la marca">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="descricion" class="col-sm-2 col-form-label">Descripcion</label>
                                    <div class="col-sm-10">
                                        <input required type="text" class="form-control" id="Descripcion" name="Descripcion" value="<?= $DataMarca->getdescripcion(); ?>" placeholder="Ingrese descripcion">
                                    </div>
                                </div>
                                <div class="form-group row">
