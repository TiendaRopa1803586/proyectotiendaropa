...
<html lang="es">
<head>
    <title><?= getenv('TITLE_SITE') ?> |  Datos de la Marca</title>
            ...
            <?php if(!empty($_GET['respuesta'])){ ?>
                <?php if ($_GET['respuesta'] == "error"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al consultar la marca: <?= ($_GET['mensaje']) ?? "" ?>
                    </div>
                <?php } ?>
                    ...
                    if(!empty($DataMarca)){
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-auto">
                                    <a role="button" href="edit.php?id=<?php echo $DataMarca->getCodigo(); ?>" class="btn btn-primary float-right" style="margin-right: 5px;">
