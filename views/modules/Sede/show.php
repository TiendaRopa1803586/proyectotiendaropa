...
<html lang="es">
<head>
    <title><?= getenv('TITLE_SITE') ?> |  Datos de Producto</title>
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Informacion de la producto</h1>
                    </div>
                    <div class="col-sm-6">
            ...
            <?php if(!empty($_GET['respuesta'])){ ?>
                <?php if ($_GET['respuesta'] == "error"){ ?>
                    <div class="alert alert-danger alert-dismissible">
                        ...
                        Error al consultar la  producto: <?= ($_GET['mensaje']) ?? "" ?>
                    </div>
                <?php } ?>
                ...
                <?php if(!empty($_GET["id"]) && isset($_GET["id"])){
                    ...
                    if(!empty($DataProducto)){
                        ...
                        <div class="card-body">
                            ...
                            <hr>
                            <hr>
                            <strong><i class="fas fa-user mr-1"></i> Importado</strong>
                            <p class="text-muted"><?= $DataProducto->getImportado() ?></p>
                            <hr>
                            ...
                            <hr>
                            <hr>
                            <strong><i class="fas fa-user mr-1"></i> Subcategoria</strong>
